...
## I. PORTADA
* [cite_start]**Tema:** Esquema Conceptual y Esquema Lógico [cite: 10, 16]
* [cite_start]**Unidad de Organización Curricular:** PROFESIONAL [cite: 11, 17]
* [cite_start]**Nivel y Paralelo:** 4to - "B" [cite: 12, 18]
* [cite_start]**Asignatura:** Base de Datos [cite: 14, 22]
* **Docente:** Ing. [cite_start]José Caiza, Mg. [cite: 15, 26]
* [cite_start]**Carrera:** Software [cite: 4]
* [cite_start]**Ciclo Académico:** Enero 2026 - Julio 2026 [cite: 5]
* [cite_start]**Alumnos Participantes:** [cite: 13]
    * [cite_start]Acaro Ibujes Pedro Sebastián [cite: 19]
    * [cite_start]Guevara López Oscar Mauricio [cite: 20]
    * [cite_start]López Yantalema Erick Alexander [cite: 21]
    * [cite_start]Mora Beltrán Santiago Sebastian [cite: 21]
...
### 2.1 Objetivos
* [cite_start]**General:** Aplicar las reglas de conversión del Esquema Conceptual al Esquema Lógico[cite: 25, 27].
* **Específicos:**
    * [cite_start]Diseñar una estructura de datos que permita identificar de forma única cada equipo tecnológico, vinculándolo a su categoría, proveedor y laboratorio físico asignado[cite: 29].
    * [cite_start]Establecer una relación histórica entre los usuarios, los equipos y los eventos de mantenimiento para monitorear el ciclo de vida de la tecnología[cite: 30].

### 2.2 Modalidad
[cite_start]Presencial[cite: 31].

### 2.3 Tiempo de duración
* [cite_start]**Presenciales:** 12 horas[cite: 33].
* [cite_start]**No presenciales:** 0 horas[cite: 34].
...
* [cite_start]**Recursos (TAC):** Plataformas educativas e Inteligencia Artificial[cite: 56, 66].
